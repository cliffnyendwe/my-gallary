...
#         searched_location = location.search_by_title(search_term)
#         message = f"{search_term}"

#         return render(request, 'all-photos/search.html',{"message":message,"location": searched_articles})
...
#         search_term = request.GET.get("categorys")
#         searched_location = location.search_by_title(search_term)
#         message = f"{search_term}"
